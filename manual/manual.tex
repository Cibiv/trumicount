...
% Fonts
\KOMAoptions{headheight=25pt,fontsize=10pt,DIV=11}
...
% Prefer whitespace over ugly paragraph splits across pages,
% but otherwise be "sloppy". This is necessary because of the
% rather long non-breakable blocks in the text -- in fussy mode,
% we got lots of overfull hboxes
\sloppy
\widowpenalty10000
\clubpenalty10000
