...
\usepackage{xcolor,graphicx,float,caption,nameref,framed,needspace,verbatim}
...
\def\beforesection@phlo{\newpage\thispagestyle{plain.scrheadings}}
\newenvironment{nosectionbreak}%
               {\let\beforesection@phlo\relax}%
               {}
...
\renewcommand\subsection{\needspace{10\baselineskip}\subsection@phlo}
\makeatother
...
\vfill
\vbox to 5cm{
\normalfont\sffamily\bfseries\Huge\centering%
TRUmiCount\\
\vfill
