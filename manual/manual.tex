...
With all prerequisites available, TRUmiCount can now be installed. The commands below install TRUmiCount into your home directory. To install TRUmiCount system-wide (assuming you have the necessary privileges), don't specify \texttt{--prefix \textasciitilde/}.
...
\begin{shellcode}
git clone git@github.com:fgp/UMI-tools.git umi_tools
cd umi_tools
