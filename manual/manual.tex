\documentclass[fontsize=10pt,DIV=11]{scrartcl}
...
\settocstylefeature[1]{entryhook}{\sffamily\bfseries}
\settocstylefeature[2]{entryhook}{\sffamily}
\settocstylefeature[1]{pagenumberhook}{\sffamily}
\settocstylefeature[2]{pagenumberhook}{\sffamily}
...
% Always break page at section boundaries
\makeatletter
\let\section@phlo\section
\newcommand\beforesection@phlo\newpage
\newenvironment{nosectionbreak}%
               {\renewcommand\beforesection@phlo\relax}%
               {\renewcommand\beforesection@phlo\newpage}
\renewcommand\section{\beforesection@phlo\section@phlo}
\makeatother

% Prefer page breaks at subsection boundaries
\makeatletter
\let\subsection@phlo\subsection
\newlength{\presubsectionskip}
\setlength{\presubsectionskip}{7\baselineskip}
\renewcommand\subsection{\vskip0pt plus \presubsectionskip\relax\pagebreak[0]\subsection@phlo}
\makeatother
...
\begin{figure}[H]
{\centering
\includegraphics[width=0.475\textwidth,page=1]{../examples/kv_1000g.pdf}\hfill
\includegraphics[width=0.475\textwidth,page=2]{../examples/kv_1000g.pdf}
\\}
...
\begin{figure}[H]
{\centering
\includegraphics[width=0.475\textwidth,page=1]{../examples/sg_100g.pdf}\hfill
\includegraphics[width=0.475\textwidth,page=2]{../examples/sg_100g.pdf}
\\}
...
\begin{figure}[H]
{\centering
\includegraphics[width=0.475\textwidth,page=1]{../examples/sg_100g_comb.pdf}\hfill
\includegraphics[width=0.475\textwidth,page=2]{../examples/sg_100g_comb.pdf}
\\}
