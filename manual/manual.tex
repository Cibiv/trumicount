...
\renewcommand\section[1]{%
  \newpage%
  % Switch page style, this changes the font size of the title in the header
  ...
  % Add TOC line
  \addcontentsline{toc}{section}{\sectionformat\GetTitleStringResult}%
